...
import com.matanalbert.assignment4.adapter.EditAuto;
...
public class Driver4 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        create.buildAuto("New-Car.txt"); // building the automobile
        synchronised(edit, times); // two synchronized methods
        waitForUpdate();
        create.printAuto(modelName);

        create.buildAuto("New-Car.txt"); // rebuild the automobile to test not synced edits
